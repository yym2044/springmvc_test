...
<title>회원목록</title>
<link rel="stylesheet" href="./durianlist/bootstrap.min.css">
...
<body>
	<form>
		<div class="container-fluid bg-light">
			...
			<div class="row box-white mt-3">
				<div class="col-6 col-md-2">
					<img src="../../../images/xdmin/coupang.png" class="img-fluid">
				</div>
				<div class="col-6 col-md-5 fs-4 mb-2 d-md-block d-none">Coupang Management System</div>

				<!-- 
				<div class="col-12 col-md-2 fs-6 mb-2">
					<img src="../../../images/xdmin/user.png" style="width: 50px;">
					<div class="row">
							<a href="#">프로필</a>
					</div>	
				</div>
				...
				<div class="col-2 col-md-1 mb-2 p-0 text-end pe-2 d-md-block d-none">
					<img src="../../../images/xdmin/lee.jpg" style="width: 40px; height: 50px;" class="rounded-circle border border-5">
				</div>
				...
				<div class="col col-md text-end d-md-block d-none">
					<button class="btn btn-outline-secondary" type="button" data-bs-toggle="offcanvas"
						data-bs-target="#offcanvasScrolling">
						<i class="bi bi-list"></i>
					</button>
					<!-- 
					<button class="btn btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNavbar">
						<i class="bi bi-list"></i>
					</button>
				 -->
				</div>
			</div>
			<div class="row box-white py-1">
				<div class="col-10 col-md-10 fs-4 mb-2 d-md-none">Coupang Management System</div>
				<div class="col col-md text-end d-md-none">
			...
			<div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
				...
				<div class="offcanvas-header">
					<img class="bi me-2" width="120" height="30" src="../../../images/xdmin/coupang.png"> </img>
				...
				<div class="offcanvas-footer">
					<div class="dropdown border-top ms-3 py-3">
						<a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2"
							data-bs-toggle="dropdown" aria-expanded="false"> <img src="../../../images/xdmin/lee.jpg" alt="" width="40"
			...
			<div class="row collapse show" id="collapseNavbar">
		...
		<div class="container-fluid bg-light">
			...
			<h4 class="d-flex"><i class="bi bi-grip-vertical text-danger"></i>회원리스트</h4>
			...
			<div class="width92">
				<div class="row">
					<div class="col-8 col-md-3 p-1 border border-2 box-white" style="margin-left: 12px;">검색결과 : <b>13</b> / 총 <b>13</b>명 검색결과</div>
					...
					<table class="table border border-1 box-white container1" style="min-width: 1000px; border-collapse: separate;">
						<thead>
							<tr>
								...
								<th>상태</th>
								<th>접속수 <!-- 
								<img class="pb-1" id="img" src="../../../images/xdmin/down.png" style="width:20px; height:20px;"></img>
							...
							<tr>
								...
								<td>
									<div class="d-flex justify-content-center align-items-center">
										<a href="#" class="btn btn-sm btn-outline-dark py-0"><i class="bi bi-chat-right-dots"></i></a> <a href="#"
											class="btn btn-sm btn-outline-dark py-0"><i class="bi bi-envelope"></i></i></a> <a href="#"
											class="btn btn-sm btn-outline-dark py-0">관리</a>
									</div>
								</td>
							</tr>
							<tr>
    ...
    function toggleImg() {
      document.getElementById("img").src = "../../../images/xdmin/up.png";
    }
